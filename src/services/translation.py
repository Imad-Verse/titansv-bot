...
{bot_sig}""",
            ...
            'bots_list_text': """📋 <b>هذه قائمة البوتات الخاصة بنا:</b>

1- 🤖 <b>إدارة الفتاوى | Fatwa CMS:</b>
مشروع خيري يهدف لأرشفة ونشر فتاوى العلماء الثقات، وتسهيل الوصول إليها.
🎯 <b>ماذا يمكنه أن يفعل لك؟</b>
• محرك بحث سريع ودقيق وتصنيف موضوعي شامل.
• دعم الوسائط المتعددة (نص، صوت، روابط).
• إمكانية النشر التلقائي للقنوات والمجموعات.
🔥 <b>جربه الآن:</b> @Fatwa_CMS_Bot

2- 🤖 <b>العملاق للمستندات | Titan Pdf Pro:</b>
🎯 <b>ماذا يمكنه أن يفعل لك؟</b>
بوت متخصص في معالجة ملفات PDF والصور والنصوص:
• تحويل الصور إلى PDF والعكس.
• دمج وتقسيم، حماية وضغط الملفات.
• إضافة علامات مائية والمزيد.
🔥 <b>جربه الآن:</b> @TitanPdfBot

3- 🤖 <b>العملاق للتحميل | Titan Downloader:</b>
🎯 <b>ماذا يمكنه أن يفعل لك؟</b>
تحميل فيديوهاتك المفضلة بأعلى جودة واستخراج الصوت منها بسهولة وسرعة (يوتيوب، تيك توك، فيسبوك، وإنستجرام).
⛔️ <b>تنبيه:</b> لا تستخدم البوت فيما يغضب الله عز وجل كتحميل الموسيقى والصور المحرمة!
🔥 <b>جربه الآن:</b> @TitanSvBot

4- 🤖 <b>بوت فذكر الدعوي | Fadhakir Bot:</b>
🎯 <b>ماذا يمكنه أن يفعل لك؟</b>
رفيقك اليومي للتذكير بالصلوات، الأذكار، والسنن، ونشر الفوائد والفيديوهات الدعوية في قناتك أو مجموعتك لنشر الخير.
🔥 <b>جربه الآن:</b> @Fadhakir_bot""",
